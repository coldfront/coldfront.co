    ...
    <Section bright>
        ...
        <div className="narrow list">
            ...
            <div className="list-item bright masterclasses">
                <h4>ColdFront</h4>
                <h2>Masterclasses</h2>
                <p>Masterclasses lead by Smashing Magazine for the curious front-end developer and designer.</p>
                <p className="location">Copenhagen</p>
                <p className="date">April 20 & 21 2019</p>
                <a className="btn btn-primary btn-primary-shadow ticket" data-text="Our events" href="/events/masterclasses">Details</a>
            </div>
